...
Java_org_emunix_metaparser_interactor_engine_MetaparserInteractor_registerExtension(JNIEnv *env,
                                                                                    jobject instance) {
    return instead_extension(&ext);
}

JNIEXPORT jint JNICALL
Java_org_emunix_metaparser_interactor_engine_MetaparserInteractor_insteadInit(JNIEnv *env,
                                                                              jobject instance,
                                                                              jstring directory,
...
Java_org_emunix_metaparser_interactor_engine_MetaparserInteractor_insteadErr(JNIEnv *env,
                                                                             jobject instance) {
...
JNIEXPORT jstring JNICALL
Java_org_emunix_metaparser_interactor_engine_MetaparserInteractor_insteadCommand(JNIEnv *env,
                                                                                 jobject instance,
                                                                                 jstring command) {
    int rc;
...
JNIEXPORT jint JNICALL
Java_org_emunix_metaparser_interactor_engine_MetaparserInteractor_insteadLoad(JNIEnv *env,
                                                                              jobject instance) {
    return instead_load(NULL);
}

JNIEXPORT void JNICALL
Java_org_emunix_metaparser_interactor_engine_MetaparserInteractor_insteadDone(JNIEnv *env,
                                                                              jobject instance) {
    instead_done();
}

JNIEXPORT jint JNICALL
Java_org_emunix_metaparser_interactor_engine_MetaparserInteractor_isRestart(JNIEnv *env,
                                                                            jobject instance) {
    int ov = need_restart;
    need_restart = 0;
    return ov;
...
JNIEXPORT jint JNICALL
Java_org_emunix_metaparser_interactor_engine_MetaparserInteractor_isSave(JNIEnv *env,
                                                                         jobject instance) {
    int ov = need_save;
    need_save = 0;
    return ov;
...
JNIEXPORT jint JNICALL
Java_org_emunix_metaparser_interactor_engine_MetaparserInteractor_isLoad(JNIEnv *env,
                                                                         jobject instance) {
    int ov = need_load;
    need_load = 0;
    return ov;
